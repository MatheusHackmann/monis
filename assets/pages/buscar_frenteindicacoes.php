...
<div class="container-fluid bg-fundo">
	<div class="row">
		<div class="offset-md-2 col-12 col-md-2 col-lg-2">
			<form action="buscar_frenteindicacoes.php" method="post" class="py-4">
	...
	<div class="row">
		<div class="offset-md-2 col-12 col-md-8 col-lg-8 py-2">
			...
			if ($_POST && $_POST['buscarIndicacao'] === "") {
				...
				$todasAsIndicacoes->setTabela("frenteindicacoes");
				...
				if ($registro === true) {
					...
					for ($i=0; $i < count($registro); $i++) { 
						...
						echo "
						<tr>
						<td>"."<a href='buscar_registroRI.php?buscar=Indicacao&nomeTabela=frenteindicacoes&nmrRegistro=$nmrRegistro&anoRegistro=$anoRegistro'>".$nmrRegistro."/".$anoRegistro."</a></td>
						<td>".$data."</td>	
						<td>".$assunto."</td>
				...
				$buscarIndicacao->setTabela("frenteindicacoes");
